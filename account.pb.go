...
func init() {
	proto.RegisterType((*Account)(nil), "ngtype.Account")
}
...
var fileDescriptor_8e28828dcb8d24f0 = []byte{
	...
	,
}
...
func (m *Account) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SubState) > 0 {
		i -= len(m.SubState)
		copy(dAtA[i:], m.SubState)
		i = encodeVarintAccount(dAtA, i, uint64(len(m.SubState)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Nonce != 0 {
...
func (m *Account) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.SubState = append(m.SubState[:0], dAtA[iNdEx:postIndex]...)
			if m.SubState == nil {
				m.SubState = []byte{}
			}
			iNdEx = postIndex
